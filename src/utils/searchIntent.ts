...
const diningPreferencePattern = /혼자|혼밥|친구|수다|여럿|모임|단체|데이트|가족|아이|조용|차분|고요|시끌|북적|활기|후딱|빨리|빠른|간단|오래|느긋|여유|가성비|분위기|특별|기념일|비\s*오는|눈\s*오는|따뜻|시원|매운|맵게|담백|든든|배부|건강|채식|비건|넓은|아늑|야외|테라스|늦게|새벽|웨이팅|예약|주차/
...
const displayIntents: Array<{ query: RegExp; evidence: RegExp; label: string }> = [
  ...
  {
    query: /떠들|수다|왁자|시끌|북적|활기/,
    evidence: /떠들|수다|왁자|시끌|북적|활기|손님이 많|사람이 많|웨이팅/,
    label: '활기찬 분위기',
  },
  {
